...
class Processing:
    def __init__(self, vs, aruco_dict_type):
        ...
        self.FT_Cali = np.load('./forcematrix.npy')
        # self.FT_Cali = np.float32([[-0.02487, 0.04816, 0.06674, -6.49216, -0.04260, 6.33225],
        #                            [-0.46122, 8.19479, -0.04453, -3.73430, 0.12033, -3.73772],
        #                            [7.48791, -0.09868, 7.69929, 0.14866, 7.42672, 0.33000],
        #                            [-3.12794, 49.81466, 42.82240, -22.00432, -41.64721, -24.28113],
        #                            [-48.67761, 0.59115, 24.43304, 40.14217, 24.75487, -37.94317],
        #                            [-1.50383, 33.07791, -0.27776, 30.43360, -0.20800, 30.61087]])
